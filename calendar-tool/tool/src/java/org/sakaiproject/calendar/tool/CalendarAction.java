...
extends VelocityPortletStateAction
{
   ...
   Properties configProps = null;
	...
	public class MergePage
	{
		...
		{
			return rb.getString("java.merge.title");
		}
 ...
 */
	...
	boolean allow_subscribe_this)
	{
		...
		//
		bar.add( new MenuEntry(mergedCalendarPage.getButtonText(),mergedCalendarPage.getToolTipText(), null, allow_merge_calendars, MenuItem.CHECKED_NA, mergedCalendarPage.getButtonHandlerID()) );
